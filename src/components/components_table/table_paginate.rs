...
pub fn Pagination<T: 'static + Serialize + Eq + Clone + FieldAccessible + Debug>(
    ...
    rsx! {
        div { class: "sticky bottom-0 w-full  border-t border-gray-200 h-30 ",
            nav {
                class: format!(
                ...
                div { class: "flex justify-end space-x-2",
                    // Previous page button
                    {
                        ...
                        rsx! {
                            button {
                                class: "relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 dark:text-white ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0 disabled:opacity-50",
                        ...
                        page_numbers
                            ...
                            .map(|page| {
                                ...
                                rsx! {
                                    button {
                                        key: "{page}",
                                        class: if is_current { "relative z-10 inline-flex items-center bg-indigo-600 px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" } else { "relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-900 dark:text-white ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0" },
                                        onclick: move |_| {
                                            let mut table = table.to_owned();
                                            table.set_page(page);
                                        },
                    ...
                    }
                    {
                        ...
                        rsx! {
                            button {
                                class: "relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-400 dark:text-white ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0 disabled:opacity-50",
